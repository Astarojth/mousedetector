...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/mice_data.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'pts/best.pt', help='model.pt path(s)')
